    ...
    for element in elements:
      ...
      for idx, level1 in enumerate(level_1s):
        ...
        for level_2 in level_2_grid:
          ...
          level_2_data = {"level_2_name" : level_2_name, "level_2_href" : level_2_href, "level_3" : []}
          ...
          if len(level_3_a) <= 0:
            level_2_data['level_3'].append({"level_3_name" : "Lain-Lain", "level_3_href" : level_2_href + "/lain-lain"})
